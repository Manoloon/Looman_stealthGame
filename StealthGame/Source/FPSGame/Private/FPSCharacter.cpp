...
AFPSCharacter::AFPSCharacter()
{
	...
	//noise emitter comp
	NoiseEmitterComp = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("AI"));
}
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AFPSCharacter, bIsCarryingObjetive);
	// this is better optimization
	//DOREPLIFETIME_CONDITION(AFPSCharacter, bIsCarryingObjetive, COND_OwnerOnly);
}